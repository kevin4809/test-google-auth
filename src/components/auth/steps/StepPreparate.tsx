  ...
  return (
    <div className='min-h-[50dvh]'>
      ...
      <p className='text-[18px] font-mono text-center mt-[20px] md:text-[28px]'>
        Ya te registraste y tu dedicatoria fue enviada. Si quieres seguir compartiendo el feeling, dedica la canción a tantas personas como quieras.
        El ganador será anunciado en las redes de Alejandro González, así que síguelo para no perderte nada del parche.
      </p>
