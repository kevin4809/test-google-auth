...
export default function ShareModal({ state, changeState, onNext }: { state: boolean; changeState: (state: boolean) => void; onNext: () => void }) {
  ...
  return (
    <div
      className={`z-20 w-[95%] max-w-[631px] fixed bottom-0 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-[url('/assets/background_footer.webp')] bg-cover bg-center bg-no-repeat rounded-[20px] px-[14.5px] 
